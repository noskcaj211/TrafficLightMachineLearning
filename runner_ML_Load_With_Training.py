...
if __name__ == "__main__":
    ...
    while(simNum<15):
        ...
        modelTrafficStay.zero_grad()
        run()
        with open('lossesCarPredictMeq_Load_With_Training_Data3'+"_"+str(simNum)+'.txt', 'w') as f:
            for item in lossesCarPredictMeq:
                f.write("%s\n" % item)
        lossesCarPredictMeq = []
        with open('lossesCarPredictBunt_Load_With_Training_Data3'+"_"+str(simNum)+'.txt', 'w') as f:
            for item in lossesCarPredictBunt:
                f.write("%s\n" % item)
        lossesCarPredictBunt = []
        with open('lossesTrafficSwitch_Load_With_Training_Data3'+"_"+str(simNum)+'.txt', 'w') as f:
            for item in lossesTrafficSwitch:
                f.write("%s\n" % item)
        lossesTrafficSwitch = []
        with open('lossesTrafficStay_Load_With_Training_Data3'+"_"+str(simNum)+'.txt', 'w') as f:
